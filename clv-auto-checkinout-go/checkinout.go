...
// doRequest is a helper to create and execute a request with browser headers
...
func ClvAutoCheckinout(username, password string) error {
	...
	fmt.Println("[INFO] Requesting login homepage ...")
	...
	fmt.Printf("[INFO] Submitting login form to: %s\n", formAction)
	...
	fmt.Println("[INFO] Calling check-in/out API ...")
